...
function App() {
  ...
  let vat = subprice1 * 0.1;
  let final_price = subprice1 + vat;
    ...
    <>
      ...
      <section className="px-3 py-5 p-md-5">
        ...
        <p className="h6 text-center">
          {(message) ? return <>Hiện có tất cả <span className="total-items text-danger fw-bold fs-5">${addedItems.length}</span> sản phẩm
          trong giỏ hàng</>  : "Hiện tại không có sản phẩm trong giỏ hàng"}
        </p>
        ...
        <div className="container pt-5">
          <div className="row g-4">
            ...
            {content} {message}
            <p className="text-secondary mt-3 text-end">Xoá hết</p>
            </div>
            <div className="col-12 col-md-4 pt-3 border rounded">
              ...
              <div className="mt-5 mb-3 d-flex flex-row flex-wrap justify-content-between align-items-center">
                ...
                <p className="h5 text-end text-danger">
                  <span className="h3 total-cost">{final_price.toLocaleString("vi-VN", {
                      style: "currency",
                      currency: "VND",
                    })}</span>
                </p>
