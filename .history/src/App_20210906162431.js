...
function App() {
  ...
  if (list.length > 0) {
    ...
    content = list.map(({ id, title, price, img, amount, array }) => (
      <MainContent
        key={id}
        title={title}
        price={price}
    ...
    vat = 0;
    final_price = 0;
    content = <p className>Không có sản phẩm</p>;
  }
        ...
        <div className="container pt-5">
          <div className="row g-4">
            <div className="col-12 col-md-8 py-0 ps-md-0">
              ...
              <button
                className={`mx-auto btn btn-light text-decoration-underline mt-3 text-end ${hideDeleteAllBtn ? "" : "d-none"}`}
                onClick={comeback}
              >
                Quay lại mua hàng
              </button>
