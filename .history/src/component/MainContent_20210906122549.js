...
function MainContent({id, price, img, title, amount }) {
  const [amount, setAmount]=useState([...addedItems])

  let temp = [...addedItems];
  let tempAmount = temp.map((item));
          ...
          <div className="row row-cols-2">
            <div className="col-12 col-lg-5">
              ...
              <div className="spinbox d-flex mx-auto ms-lg-0">
                <div className="border flex-fill text-center border-end-0 border-secondary rounded-start" onClick={(e)=>increaseAmount(e,id)}>
