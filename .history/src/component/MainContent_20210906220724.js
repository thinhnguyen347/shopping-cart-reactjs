...
export default function MainContent({id, price, img, title, amount}, decrease, increase, changeTotal, deleteItem) {
          ...
          <div className="row row-cols-2">
            ...
            <div className="col-6 col-md-6 col-lg-4 position-relative">
              ...
              <p className="h5 py-1 py-lg-2 text-center fw-bold">
                <span className="price" onChange={changeTotal}>
              ...
              <button className="btn-close position-absolute end-0 top-0 p-0 mt-0 me-2 me-lg-4" onClick={deleteItem}></button>
            </div>
          </div>
        </div>
      </div>
