...
function MainContent({ id, price, img, title, amount }) {
  ...
  let subtotal1 = temp.map((item) => item.amount * item.price);

  function decreaseAmount(e) {
    let id = e.target.id;
    let index = temp.findIndex(id, temp);
          ...
          <div className="row row-cols-2">
            <div className="col-12 col-lg-5">
              ...
              <div className="spinbox d-flex mx-auto ms-lg-0">
                <div
                  className="border flex-fill text-center border-end-0 border-secondary rounded-start"
                  onClick={(e) => decreaseAmount(e, id)}
                >
