        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-auto me-0">
            ...
            <li className="nav-item d-block d-sm-block d-md-block d-lg-none d-xl-none d-xxl-none">
              <a className="nav-link" href="/">
                Giỏ hàng <span className="badge bg-danger rounded-circle">{itemAmount}</span>
              </a>
            </li>
          </ul>
          ...
          >
            <div className="position-relative">
              <FaShoppingCart />
              <span className="position-absolute top-0 start-100 translate-middle p-1 badge bg-danger rounded-pill">{itemAmount}</span>
            </div>
          </a>
