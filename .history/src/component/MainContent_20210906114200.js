        ...
        <div className="col-12 col-md-8 col-lg-10 container-fluid">
          <div className="row row-cols-2">
            ...
            <div className="col-12 col-md-6 col-lg-3">
              <p className="py-1 text-center">Đơn giá</p>
              <p className=" py-lg-2 text-center">
            ...
            <div className="col-12 col-md-6 col-lg-4">
              <p className=" py-1 text-center">Thành tiền</p>
              <p className="h5 py-lg-2 text-center fw-bold">
                <span className="price">
                  {price.toLocaleString("vi-VN", {
                    style: "currency",
                    currency: "VND",
